    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a class="nav-link scrollto active" href="/investors">INVESTORS</a>
            <ul>
  ...
  <section id="hero" style="width:100%;height:600px; border-bottom: 3px solid #dcaa0a;">
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/hero-carousel/TAYABDUMPSITE2.jpg)">
          ...
          <div class="container" style="margin-top: 50px">
            <div class="row"  style="text-align:left;">   
              <div class="col-3">
                  ...
                  <a class="nav-link" id="broker-tab" data-toggle="pill" href="#broker" role="tab" aria-controls="broker" aria-selected="false">Broker notes</a>
                  <a class="nav-link" id="corporate-tab" data-toggle="pill" href="#corporate" role="tab" aria-controls="corporate" aria-selected="false">Corporate documents</a>
                  <a class="nav-link" id="aim-rule-tab" data-toggle="pill" href="#aim-rule" role="tab" aria-controls="aim-rule" aria-selected="false">AIM Rule 26</a>
                  </div>
              </div>
              <div class="col-9">
                  <div class="tab-content" id="v-pills-tabContent">
                  <div class="tab-pane fade show active" id="share" role="tabpanel"  aria-labelledby="v-pills-home-tab">
                    <p > Share price information
                    </p>
                  </div>
